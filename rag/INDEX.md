...
- [chatgpt-app/gpt-connector-implementation-20260713.md](chatgpt-app/gpt-connector-implementation-20260713.md) — core／CLI／stdio MCP実装、23 tests、実browser one-shot／2turn／model-effort／archive、auth／空SSE故障注入、反証修正7件、npm 0.1.0公開／global CLI・MCP smoke、pnpm 11とFetch URL patternの罠を記録（2026-07-13・ローカル実測）
